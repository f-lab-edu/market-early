...
ENTRYPOINT ["java", "-Xms3g", "-Xmx3g", "-Dspring.profiles.active=prod,secret", "-jar", "app.jar", "--seeder=15000","-Dspring.config.additional-location=file:/app/config/application-secret.properties"]