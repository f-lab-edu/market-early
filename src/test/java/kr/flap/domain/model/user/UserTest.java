...
class UserTest {
  ...
  public void setUp() {
    ...
    fixAddressData = createAddressData();
...
//  @Rollback(value = false)
  ...
  void saveUserAddress() {
    assertThat(userAddressRepository.findAll().size()).isEqualTo(numberOfData);
  ...
  void readUserAddress() {
    ...
    assertThat(userAddress1.getAddressDetail()).isEqualTo("역삼동 000-0");
    assertThat(userAddress1.getZipCode()).isEqualTo("00000");
    ...
    assertThat(userAddress2.getAddressDetail()).isEqualTo("역삼동 111-1");
    assertThat(userAddress2.getZipCode()).isEqualTo("11111");
  }
  ...
  void readReserve() {
    ...
    assertThat(reserve.getAmount()).isEqualTo(BigDecimal.valueOf(0));
